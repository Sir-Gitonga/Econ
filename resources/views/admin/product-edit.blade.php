    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{adminRoute('admin.products')}}">
        ...
        <!-- form-add-product -->
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{adminRoute('admin.product.update')}}">
           @csrf
           @method('PUT')
            ...
            <div class="wg-box">
                ...
                <fieldset class="shortdescription">
                    <div class="body-title mb-10">Short Description <span
                            class="tf-nelor-1">*</span></div>
                            <textarea class="mb-10 ht-150" name="short_description" placeholder="Short Description" tabindex="0" required>{{$product->short_description}}</textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the
                        product name.</div>
                </fieldset>
                ...
                <fieldset class="description">
                    ...
                    <textarea class="mb-10" name="description" placeholder="Description"
                     tabindex="0" required>{{$product->description}}</textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the
                        product name.</div>
                </fieldset>
    ...
    $(function(){
        ...
        $("#gFile").on("change", function(e){
            ...
            $.each(gphotos, function(key, val) {
                $("#galUpload").prepend(`<div class="items gitrems"><img src="${URL.createObjectURL(val)}" alt="Gallery Image"/></div>`);
            });
        });
