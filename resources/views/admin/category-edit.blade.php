    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{adminRoute('admin.categories')}}">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{adminRoute('admin.category.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
