    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <a class="tf-button style-1 w208" href="{{adminRoute('admin.orders')}}">Back</a>
            </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">{{$item->product ? $item->product->SKU : 'N/A'}}</td>
                            <td class="text-center">{{$item->product && $item->product->category ? $item->product->category->name : 'N/A'}}</td>
                            <td class="text-center">{{$item->product && $item->product->brand ? $item->product->brand->name : 'N/A'}}</td>
        ...
        <div class="wg-box mt-5">
            ...
            <form action="{{adminRoute('admin.order.status.update')}}" method="POST">
                @csrf
                @method('PUT')
