    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{adminRoute('admin.brands')}}">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{adminRoute('admin.brand.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div class="item" id="imgpreview">
                            <img src="{{asset('upload/brands')}}/{{$brand->image}}" class="effect8" alt="">
                        </div>
                        @endif
