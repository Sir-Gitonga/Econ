    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{adminRoute('admin.slide.add')}}">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{adminRoute('admin.slide.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div class="item" id="imgpreview">
                            <img src="{{asset('uploads/slides')}}/{{$slide->image}}" class="effects8" alt=""/>
                        </div>
                        @endif
                ...
                <fieldset class="category">
                    ...
                    <div class="select flex-grow">
                        <select class="" name="status">
                            ...
                            <option value="1" @if($slide->status =="0") selected @endif>Inactive</option>
                        </select>
                    </div>
                </fieldset>
                @error('status')
