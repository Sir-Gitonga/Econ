...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{adminRoute('admin.slide.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="name">
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview" style="display:none;">
                            <img src="sample.jpg" class="effects8" alt=""/>
                        </div>
                ...
                <fieldset class="category">
                    ...
                    <div class="select flex-grow">
                        <select class="" name="status">
                            ...
                            <option value="1" @if(old('status')=="0") selected @endif>Inactive</option>
                        </select>
                    </div>
                </fieldset>
                @error('status')
