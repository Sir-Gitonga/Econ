              ...
              <div class="checkout__totals-wrapper">
                <div class="sticky-content">
                  <div class="checkout__totals">
                   ...
                   <table table class="checkout-totals">
                        <tbody>
                            <tr class="text-right">
                                <th>Subtotal</th>
                            ...
                            <tr class="text-right">
                                ...
                                <td>${{ optional(Session::get('discounts'))['discount'] ?? '0.00' }}</td>
                            </tr>
                            <tr class="text-right">
                                <th>Subtotal After Discount</th>
                                <td>${{ optional(Session::get('discounts'))['subtotal'] ?? Cart::instance('cart')->subtotal() }}</td>
                            </tr>
                            <tr class="text-right">
                                <th>Shipping</th>
                                <td>Free</td>
                  ...
                  <div class="checkout__payment-methods">
                    ...
                    <div class="form-check">
                    <input class="form-check-input form-check-input_fill" type="radio" name="mode" id="mode4" value="mpesa">
